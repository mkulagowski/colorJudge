...
/**
 * Created by mkk-1 on 21/05/2017.
 */

public class JudgePreActivity extends AppCompatActivity {
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
           ...
           // if (ContextCompat.checkSelfPermission(JudgePreActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
         //       ActivityCompat.requestPermissions(JudgePreActivity.this, new String[]{Manifest.permission.CAMERA}, RequestPermissions.REQUEST_PERMISSIONS);
         //   } else {
